...
# -*- coding: utf-8 -*-
"""
Created on Wed Oct 25 15:26:16 2023

@author: klaudio
"""

# Performin Singular Spectral Analysis on an arbitrary time series
import numpy as np
...
window_size = 30
groups = [np.arange(i, i + 5) for i in range(0, 26, 5)]
...
# The index 0 here refers to the first row of X that contains the original signals
